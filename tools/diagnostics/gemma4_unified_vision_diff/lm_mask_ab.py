...
QUESTION = ("Look closely at the terminal / agent panel in this screenshot. "
...
def main():
    ...
    text = proc.apply_chat_template(messages,
                                    add_generation_prompt=True,
                                    tokenize=False)
    inputs = proc(text=[text],
                  images=[img],
    ...
    for target in ["36793", "b23ce7c"]:
        marks = {
            a: ("HIT" if target in t else "miss")
